...
REV = "6830a8c0bc06ce87bcd34b3b08e214c5f1763311"
BASE = "v1.6.1"
...
for name, data in sorted(payload.items()):
    ...
    skills.append({"name": folder.rsplit("/", 1)[1], "path": name, "delta_from_withdrawn_1_6_1": state,
...
zipname = OUT / "memova-1.15.0-source-candidate.zip"
